function DevTools() {
  ...
  this.init = function() {
    this.devTools.innerHTML =
      "<button onclick='devTools.setCheat(\"pI\")'>Player Invincability </button> <br>" +
      "<button onclick='devTools.setCheat(\"nI\")'>Nexus Invincability </button> <br>" +
      "<button onclick='devTools.setCheat(\"eS\")'>Enemies Spawn </button> <br>" +
      "<button onclick='devTools.killEnemies()'>Kill All Enemies </button> <br>" +
      "<button onclick='devTools.healPlayer()'>Heal Player </button> <br>" +
      "<button onclick='devTools.healNexus()'>Heal Nexus </button> <br>" +
      "<button onclick='devTools.showDevInfo()'>Show DevInfo </button> <br>";
  }
